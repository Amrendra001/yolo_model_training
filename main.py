...
if __name__ == '__main__':
        ...
        model.train(data="data.yaml", epochs=1, save_period=10, val=True, project='Localisation_auto_training', name='Training', batch=32, cache='ram', close_mosaic=10, single_cls=True)
