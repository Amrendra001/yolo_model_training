...
if __name__ == '__main__':
        ...
        model.train(data="data.yaml", epochs=100, save_period=10, val=True, project='Yolov8m_traning', batch=64, name='Training', cache='ram', close_mosaic=20, single_cls=True)
